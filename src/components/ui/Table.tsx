...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 p-2 md:p-3 text-right align-middle text-xs font-semibold uppercase tracking-wide text-brown/70",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-2 md:p-3 align-middle text-brown", className)}
    {...props}
  />
));
